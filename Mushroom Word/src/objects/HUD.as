   ...
   import starling.text.TextField;
	...
	public  class HUD extends Sprite
	{
		...
		{ 
			...
			TimeTextAmount = new TextField(120, 100, "90", TimeAmount.fontName, 35,0xE8E8E8   );
			...
			ScoreText = new TextField(120, 100, "0", Score.fontName, 35,0xE8E8E8   );
			ScoreText.x =80;
			ScoreText.y =470;
			...
			PointText = new TextField(120, 100, "0", Point.fontName, 35,0xE8E8E8   );
			PointText.x =180;
			PointText.y =470;
